...
from demobl.Locator.locater import Locators
from demobl.Basse.demobz_base import BasePage


class EndToEnd(Locators, BasePage):
    ...
    ## login corrrectly 4
    def execute_loginout(self):
        self._click(By.XPATH, self.home)
        self._click(By.XPATH, self.loginno)
        time.sleep(1)
        self._write(By.XPATH, self.loginno_name, 'wasse')
        self._write(By.XPATH, self.loginno_password, '123was')
        self._click(By.XPATH, self.loginno_button)
        self._click(By.XPATH, self.loginno_out)
        time.sleep(2)
    ...
    def execute_backGround_color(self):
        # self.back_ground_color(By.CSS_SELECTOR, self.back_gcolore)
        pytest.skip('skipping test..later i will check it')
        # assert self.back_gcolore == "blue"

    def execute_phones(self):
        self._click(By.XPATH, self.phones_home)
        self._click(By.XPATH, self.phones_cate)
        self._click(By.XPATH, self.phones_item)
        assert self.message(self.phones_name) == "Iphone 6 32gb"
        self._click(By.XPATH, self.phones_add)
        self.alert_ok()
        self._click(By.XPATH, self.monitors_home1)

    def execute_lapto(self):
        self._click(By.XPATH, self.laptops_home)
        self._click(By.XPATH, self.laptops_cate)
        self._click(By.XPATH, self.laptops_item)
        assert self.message(self.laptops_name) == "MacBook air"
        self._click(By.XPATH, self.laptops_add)
        self.alert_ok()
        self._click(By.XPATH, self.monitors_home1)

    def execute_monitor(self):
        self._click(By.XPATH, self.monitors_home)
        self._click(By.XPATH, self.monitors_cate)
        self._click(By.XPATH, self.monitors_item)
        assert self.message(self.monitors_name) == "ASUS Full HD"
        self._click(By.XPATH, self.monitors_add)
        self.alert_ok()
        self._click(By.XPATH, self.monitors_home1)
    ...
    def execute_about_us(self):  ## cheking about us 13
        ...
        # self._click(By.XPATH, self.about_us_header)
    ...
    def back_col(self):
        return self._find(By.XPATH, "//body").value_of_css_property("background-color")
